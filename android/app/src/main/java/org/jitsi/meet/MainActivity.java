...
import cloud.siemens.mmmr.sdk.JitsiMeet;
import cloud.siemens.mmmr.sdk.JitsiMeetActivity;
import cloud.siemens.mmmr.sdk.JitsiMeetConferenceOptions;
...
public class MainActivity extends JitsiMeetActivity {
    ...
    protected boolean extraInitialize() {
        ...
        try {
            Class<?> cls = Class.forName("cloud.siemens.mmmr.GoogleServicesHelper");
