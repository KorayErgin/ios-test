...
public class BroadcastEvent {
    ...
    public enum Type {
        CONFERENCE_BLURRED("cloud.siemens.mmmr.CONFERENCE_BLURRED"),
        CONFERENCE_FOCUSED("cloud.siemens.mmmr.CONFERENCE_FOCUSED"),
        CONFERENCE_JOINED("cloud.siemens.mmmr.CONFERENCE_JOINED"),
        CONFERENCE_TERMINATED("cloud.siemens.mmmr.CONFERENCE_TERMINATED"),
        CONFERENCE_WILL_JOIN("cloud.siemens.mmmr.CONFERENCE_WILL_JOIN"),
        AUDIO_MUTED_CHANGED("cloud.siemens.mmmr.AUDIO_MUTED_CHANGED"),
        PARTICIPANT_JOINED("cloud.siemens.mmmr.PARTICIPANT_JOINED"),
        PARTICIPANT_LEFT("cloud.siemens.mmmr.PARTICIPANT_LEFT"),
        ENDPOINT_TEXT_MESSAGE_RECEIVED("cloud.siemens.mmmr.ENDPOINT_TEXT_MESSAGE_RECEIVED"),
        SCREEN_SHARE_TOGGLED("cloud.siemens.mmmr.SCREEN_SHARE_TOGGLED"),
        PARTICIPANTS_INFO_RETRIEVED("cloud.siemens.mmmr.PARTICIPANTS_INFO_RETRIEVED"),
        CHAT_MESSAGE_RECEIVED("cloud.siemens.mmmr.CHAT_MESSAGE_RECEIVED"),
        CHAT_TOGGLED("cloud.siemens.mmmr.CHAT_TOGGLED"),
        VIDEO_MUTED_CHANGED("cloud.siemens.mmmr.VIDEO_MUTED_CHANGED"),
        READY_TO_CLOSE("cloud.siemens.mmmr.READY_TO_CLOSE");
