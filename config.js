...
var config = {
    ...
    deeplinking: {
         ...
         desktop: {
             appName: 'MMM Remote Interactive'
         },
         // If true, any checks to handoff to another application will be prevented
         // and instead the app will continue to display in the current browser.
    //     disabled: false,
         ...
         ios: {
             ...
             appScheme: 'com.siemens.mmmremoteinteractive',
         ...
         android: {
             ...
             downloadLink: 'https://play.google.com/store/apps/details?id=com.siemens.mmmremoteinteractive',
             // Android app package name.
             appPackage: 'com.siemens.mmmremoteinteractive',
             fDroidUrl: 'https://f-droid.org/en/packages/com.siemens.mmmremoteinteractive/',
             dynamicLink: {
                 apn: 'com.siemens.mmmremoteinteractive',
                 appCode: 'w2atb',
                 customDomain: undefined,
