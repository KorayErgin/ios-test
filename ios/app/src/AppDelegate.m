...
-             (BOOL)application:(UIApplication *)application
  didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    jitsiMeet.customUrlScheme = @"com.siemens.mmmremoteinteractive";
    jitsiMeet.universalLinkDomains = @[@"interactive.mmmr.siemens.cloud", @"alpha.jitsi.net", @"beta.interactive.mmmr.siemens.cloud"];
    ...
    jitsiMeet.defaultConferenceOptions = [JitsiMeetConferenceOptions fromBuilder:^(JitsiMeetConferenceOptionsBuilder *builder) {
        ...
        builder.serverURL = [NSURL URLWithString:@"https://interactive.mmmr.siemens.cloud"];
    }];
