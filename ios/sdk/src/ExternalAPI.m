...
// Events
static NSString * const hangUpAction = @"cloud.siemens.mmmr.HANG_UP";
static NSString * const setAudioMutedAction = @"cloud.siemens.mmmr.SET_AUDIO_MUTED";
static NSString * const sendEndpointTextMessageAction = @"cloud.siemens.mmmr.SEND_ENDPOINT_TEXT_MESSAGE";
static NSString * const toggleScreenShareAction = @"cloud.siemens.mmmr.TOGGLE_SCREEN_SHARE";
static NSString * const retrieveParticipantsInfoAction = @"cloud.siemens.mmmr.RETRIEVE_PARTICIPANTS_INFO";
static NSString * const openChatAction = @"cloud.siemens.mmmr.OPEN_CHAT";
static NSString * const closeChatAction = @"cloud.siemens.mmmr.CLOSE_CHAT";
static NSString * const sendChatMessageAction = @"cloud.siemens.mmmr.SEND_CHAT_MESSAGE";
static NSString * const setVideoMutedAction = @"cloud.siemens.mmmr.SET_VIDEO_MUTED";
static NSString * const setClosedCaptionsEnabledAction = @"cloud.siemens.mmmr.SET_CLOSED_CAPTIONS_ENABLED";
static NSString * const toggleCameraAction = @"cloud.siemens.mmmr.TOGGLE_CAMERA";
