...
// Events
static NSString * const hangUpAction = @"com.siemens.mmmremoteinteractive.HANG_UP";
static NSString * const setAudioMutedAction = @"com.siemens.mmmremoteinteractive.SET_AUDIO_MUTED";
static NSString * const sendEndpointTextMessageAction = @"com.siemens.mmmremoteinteractive.SEND_ENDPOINT_TEXT_MESSAGE";
static NSString * const toggleScreenShareAction = @"com.siemens.mmmremoteinteractive.TOGGLE_SCREEN_SHARE";
static NSString * const retrieveParticipantsInfoAction = @"com.siemens.mmmremoteinteractive.RETRIEVE_PARTICIPANTS_INFO";
static NSString * const openChatAction = @"com.siemens.mmmremoteinteractive.OPEN_CHAT";
static NSString * const closeChatAction = @"com.siemens.mmmremoteinteractive.CLOSE_CHAT";
static NSString * const sendChatMessageAction = @"com.siemens.mmmremoteinteractive.SEND_CHAT_MESSAGE";
static NSString * const setVideoMutedAction = @"com.siemens.mmmremoteinteractive.SET_VIDEO_MUTED";
static NSString * const setClosedCaptionsEnabledAction = @"com.siemens.mmmremoteinteractive.SET_CLOSED_CAPTIONS_ENABLED";
static NSString * const toggleCameraAction = @"com.siemens.mmmremoteinteractive.TOGGLE_CAMERA";
