...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'MMM/R Interactive';

    ios.appName = ios.appName || 'MMM/R Interactive';
    ios.appScheme = ios.appScheme || 'cloud.siemens.mmmr';
    ios.downloadLink = ios.downloadLink
        || 'https://itunes.apple.com/us/app/jitsi-meet/id1165103905';
    if (ios.dynamicLink) {
        ios.dynamicLink.apn = ios.dynamicLink.apn || 'cloud.siemens.mmmr';
    ...
    android.appName = android.appName || 'MMM/R Interactive';
    android.appScheme = android.appScheme || 'cloud.siemens.mmmr';
    android.downloadLink = android.downloadLink
        || 'https://play.google.com/store/apps/details?id=cloud.siemens.mmmr';
    android.appPackage = android.appPackage || 'cloud.siemens.mmmr';
    android.fDroidUrl = android.fDroidUrl || 'https://f-droid.org/en/packages/cloud.siemens.mmmr/';
    if (android.dynamicLink) {
        android.dynamicLink.apn = android.dynamicLink.apn || 'cloud.siemens.mmmr';
