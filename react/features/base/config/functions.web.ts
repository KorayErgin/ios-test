...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'MMM Remote Interactive';

    ios.appName = ios.appName || 'MMM Remote Interactive';
    ios.appScheme = ios.appScheme || 'com.siemens.mmmremoteinteractive';
    ios.downloadLink = ios.downloadLink
        || 'https://itunes.apple.com/us/app/jitsi-meet/id1165103905';
    if (ios.dynamicLink) {
        ios.dynamicLink.apn = ios.dynamicLink.apn || 'com.siemens.mmmremoteinteractive';
    ...
    android.appName = android.appName || 'MMM Remote Interactive';
    android.appScheme = android.appScheme || 'com.siemens.mmmremoteinteractive';
    android.downloadLink = android.downloadLink
        || 'https://play.google.com/store/apps/details?id=com.siemens.mmmremoteinteractive';
    android.appPackage = android.appPackage || 'com.siemens.mmmremoteinteractive';
    android.fDroidUrl = android.fDroidUrl || 'https://f-droid.org/en/packages/com.siemens.mmmremoteinteractive/';
    if (android.dynamicLink) {
        android.dynamicLink.apn = android.dynamicLink.apn || 'com.siemens.mmmremoteinteractive';
