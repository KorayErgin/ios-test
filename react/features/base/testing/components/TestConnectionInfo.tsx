...
class TestConnectionInfo extends Component<IProps, State> {
    ...
    render() {
        ...
        return (
            <Fragment>
                <TestHint
                    id = 'com.siemens.mmmremoteinteractive.conference.connectionState'
                    value = { this.props._conferenceConnectionState } />
                <TestHint
                    id = 'com.siemens.mmmremoteinteractive.conference.joinedState'
                    value = { this.props._conferenceJoinedState } />
                <TestHint
                    id = 'com.siemens.mmmremoteinteractive.conference.grantModeratorAvailable'
                    value = { 'true' } />
                <TestHint
                    id = 'com.siemens.mmmremoteinteractive.conference.localParticipantRole'
                    value = { this.props._localUserRole } />
                <TestHint
                    id = 'com.siemens.mmmremoteinteractive.stats.rtp'
