...
class TestConnectionInfo extends Component<IProps, State> {
    ...
    render() {
        ...
        return (
            <Fragment>
                <TestHint
                    id = 'cloud.siemens.mmmr.conference.connectionState'
                    value = { this.props._conferenceConnectionState } />
                <TestHint
                    id = 'cloud.siemens.mmmr.conference.joinedState'
                    value = { this.props._conferenceJoinedState } />
                <TestHint
                    id = 'cloud.siemens.mmmr.conference.grantModeratorAvailable'
                    value = { 'true' } />
                <TestHint
                    id = 'cloud.siemens.mmmr.conference.localParticipantRole'
                    value = { this.props._localUserRole } />
                <TestHint
                    id = 'cloud.siemens.mmmr.stats.rtp'
