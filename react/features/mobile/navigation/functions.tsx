...
import { IconCloseLarge ,IconGear} from '../../base/icons/svg';
import { toState } from '../../base/redux/functions';
import { cancelKnocking } from '../../lobby/actions.native';

import HeaderNavigationButton from './components/HeaderNavigationButton';
import { goToSettings as goToSettingsScreen } from './rootNavigationContainerRef';
 ...
 * @returns {React.Component}
 */
export function screenHeaderSettingsButton() {
    const { t } = useTranslation();
    ...
    return (
        <HeaderNavigationButton
            src = { IconGear }  onPress={goToSettingsScreen}/>
    );
}
